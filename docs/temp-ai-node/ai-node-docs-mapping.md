...
| `/home/dan/Projects/SynthiaAiNode/docs/node-capability-declaration.md` | `docs/fastapi/api-reference.md`, `docs/architecture.md` | AI Node repo | Node -> Golden references | Capability declaration remains planned; golden API docs should reference when implemented endpoints exist. |
