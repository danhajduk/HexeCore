...
| --- | --- | --- | --- | --- |
| `/home/dan/Projects/SynthiaAiNode/docs/ai-node-architecture.md` | `docs/platform-architecture.md`, `docs/mqtt-platform.md` | AI Node repo | Node -> Golden references | Golden docs link to this architecture source; no duplicate copy in golden repo. |
| `/home/dan/Projects/SynthiaAiNode/docs/node-capability-declaration.md` | `docs/api-reference.md`, `docs/platform-architecture.md` | AI Node repo | Node -> Golden references | Capability declaration remains planned; golden API docs should reference when implemented endpoints exist. |
