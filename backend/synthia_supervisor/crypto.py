...
def verify_release_option_a(
    ...
    Option A verification:
      ...
      - signature must verify over SHA256(artifact_bytes) digest BYTES
        using ed25519 public key referenced by publisher_key_id.
    """
    ...
    actual_hex, digest_bytes = _sha256_hex_and_bytes(artifact_path)
