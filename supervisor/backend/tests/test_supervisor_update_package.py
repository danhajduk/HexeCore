...
class TestSupervisorUpdatePackage(unittest.TestCase):
    ...
    def test_build_package_excludes_runtime_artifacts_and_generates_checksum(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            package = build_supervisor_update_package(self._source_root(tmp), source_version="0.6.0", commit_sha="abc123")
        ...
        self.assertEqual(package.manifest["source_version"], "0.6.0")
