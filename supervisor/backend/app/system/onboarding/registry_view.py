...
def node_registry_payload(item, node_governance_status_service: NodeGovernanceStatusService | None = None) -> dict[str, object]:
    ...
    return {
        ...
        "requested_api_base_url": getattr(item, "requested_api_base_url", None),
        "ui_enabled": bool(getattr(item, "ui_enabled", False)),
        "ui_base_url": getattr(item, "ui_base_url", None),
        "ui_mode": getattr(item, "ui_mode", None),
        "ui_health_endpoint": getattr(item, "ui_health_endpoint", None),
        "api_base_url": getattr(item, "api_base_url", None),
